...
namespace Jwell.Repository.Context
{
    public class JwellKPIDbContext: DbContext
    {
        ...
        public IDbSet<AuthOrganization> AuthOrganization { get; set; }

        public IDbSet<AuthUser> AuthUser { get; set; }
        #region 配置信息
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Conventions.Remove<DecimalPropertyConvention>();
            modelBuilder.Conventions.Add(new DecimalPropertyConvention(18, 4));
            modelBuilder.HasDefaultSchema(DbContextContant.KPISCHEMA);
